...
file_name = "assets/South_Sumatra_Daily_Forecast.met"
...
print("Stitching Data: History -> 16-Day Forecast")
...
# Concatenate: Full History -> Short-term. 
df_stitched = pd.concat([df_hist_full, df_cast]).drop_duplicates(subset=['date'], keep='first').reset_index(drop=True)
...
with open(file_name, "w") as f:
    ...
    f.write("! Data: Open-Meteo Historical + 16-Day Forecast (Incrementally Updated)\n")
...
print(f"Pipeline complete! Overwrote {file_name} with freshest daily forecast data.")
